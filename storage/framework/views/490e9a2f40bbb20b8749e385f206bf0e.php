...
<?php endif; ?>
    ...
    <div class="form-title">Login to FotoFoshi</div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ms-3','style' => 'background-color: #ffc700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-3','style' => 'background-color: #ffc700']); ?>
...
<?php endif; ?>
    ...
    <div class="modal-body" style="padding:1rem">Dont have an account? <a href="<?php echo e(route('register')); ?>" class="signUpbtn">Sign Up</a></div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\FotoFoshi\resources\views/auth/login.blade.php ENDPATH**/ ?>